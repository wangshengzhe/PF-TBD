...
%  %改
%  qq2(k+1,i)=computweight(xp2(:,k+1,i),LR1,ST(k+1),RT11(k+1),E1(k+1,i),Dr,Db,Dd,Nr,Nd,Amp,Lr,Lb,delta_n,z_rdb12(:,:,:,k+1),r,d,b,Nb,Ld);
%     end
...
%   q(k+1,i)=1;
end%重采样得到xp1(:,k+1,i)，  axp1(:,k+1,i)， E1(k+1,i)
...
%     end
    ...
    for i=1:N
        Pb1(1,k+1)=Pb1(1,k+1)+E1(k+1,i);
         axe1(:,k+1)=axe1(:,k+1)+E1(k+1,i)*axp1(:,k+1,i);%状态和
    end
    if Pb1(1,k+1)~=0;
       axe1(:,k+1)=axe1(:,k+1)/Pb1(1,k+1);%状态估计
    end 
